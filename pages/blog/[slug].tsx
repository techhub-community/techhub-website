...
const Post: React.FC<{ post: Post }> = (props) => {
  ...
  let metaObject = {
    n_title: `${post.title} :: dntandan-blog`,
    n_description: `${post.custom_excerpt}`,
    n_og_url: `https://dntandan.ml/blog/${post.slug}`,
    n_og_title: `${post.title} :: dntandan-blog`,
    n_og_description: `${post.custom_excerpt}`,
    n_og_image: `${post.feature_image}`,
    n_twitter_url: `https://dntandan.ml/blog/${post.slug}`,
    n_twitter_title: `${post.title} :: dntandan-blog`,
